...
| 07 | `analyze_identity_geometry.py` | 2 | **B** (2.2 — PROBE NULL LANDED) · M (2.1 — FIX LANDED, 4.1 — FIX LANDED) · m (2.8 — VERIFIER LANDED, 5.9, 5.10) | [07_analyze_identity_geometry.md](07_analyze_identity_geometry.md) |
| 08 | `analyze_identity_geometry_diagnostics.py` | 2 | **B** (2.2 — PROBE NULL LANDED) · M (2.1 — FIX LANDED, 4.1 — FIX LANDED) · m (2.8 — VERIFIER LANDED, 5.9, 5.10) — strengths to keep | [08_analyze_identity_geometry_diagnostics.md](08_analyze_identity_geometry_diagnostics.md) |
